...
; run script as admin (reload if not as admin) if not A_IsAdmin { Run *RunAs "%A_ScriptFullPath%" ExitApp } FileCreateShortcut, %A_ScriptFullPath%, %A_Startup%\shortcutname.lnk
